...
|---|---|---|
| piramid (`piramid2_C`) — devs'-gauntlet acceptance case | [piramid.md](piramid.md) | AS-BUILT v102 (07-05 arc, 6 live-tested rounds: tracking `ff338d87` [V] -> [WA-TRACE] -> v99 SCALE [V «идёт»] -> v100 auxYaw facing [user: «хороший результат»] -> gather SUCK `7ec1f666` **[V by user: «засасывание зеркально 100%»]** -> v102 head/searchlight relLook stream `a255b70f`). Pending: 0y head re-verdict + TRUE mid-join (11:25 was join-before-event) |
